...
export const TIPS: string[] = [
  ...
  'Open Filters to narrow by genre, year, length, charter or album on RhythmVerse.',
  'Genre, year and length filters only work on RhythmVerse; Chorus Encore filters by instrument and difficulty.',
